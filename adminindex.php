...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
	...
	$email = $conn->real_escape_string($_POST['email']);
	//if(preg_match("/^[a-zA-Z@chowgules.ac.in]*$/",$email)){
...
<div class="navbar-fixed"> 
 ...
 <nav style="background-color:black; height:90px; border-bottom:4px solid #de0e0e;" class="z-depth-5 ">
    <div class="nav-wrapper">
	 ...
	 <?php if(isset($_SESSION['firstname'])){ ?>
	 <div style="">
	 <a id="notification-icon" class="dropdown-button btn-floating" data-beloworigin="true" href="#" data-activates="dropdown1" style="float:right;"><i class="material-icons prefix" >notifications</i></a>
	</div>
...
<h3 style="font-family: 'Hind Madurai'; padding-left:10px;padding-top:10px;" class="flow-text">Recent Questions</h3>
...
?>
    ...
    <li class="collection-item avatar">
	  ...
	  <span class="title"><?php echo $time; ?></span>
	   ...
	   ?>
	  <a href="del.php?qid=<?php echo $qid ?>&val=2" class="secondary-content tooltipped" data-tooltip="Delete" data-position="bottom" data-delay="50"><i class="material-icons">highlight_off</i></a>
	   
	 
<div class="row">
	  <div class="col s12 m12 l12">
	  <a href="vote.php?qid=<?php echo $qid ?>&val=1" class="linkcolor tooltipped" data-position="bottom" data-delay="50" data-tooltip="Upvote"><i class="material-icons">thumb_up</i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	  <a href="vote.php?qid=<?php echo $qid ?>&val=2" class="linkcolor tooltipped" data-position="bottom" data-delay="50" data-tooltip="Downvote"><i class="material-icons">thumb_down</i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	  <a href="vote.php?qid=<?php echo $qid ?>&val=3" class="linkred tooltipped" data-position="bottom" data-delay="50" data-tooltip="Report"><i class="material-icons">report</i></a>
